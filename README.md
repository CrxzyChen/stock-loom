...
**Windows x64 · Alpha · MIT**

[下载 Alpha](https://github.com/CrxzyChen/stock-loom/releases) · [版本说明](docs/alpha-release.md) · [参与开发](CONTRIBUTING.md)
...
1. 从 Releases 下载并安装 Windows x64 安装包。本次 Alpha 未签名，Windows 可能提示未知发布者。
...
目前仅发布 Windows x64，未完成异机安装验收。使用前建议备份本地数据。第三方模型兼容性取决于服务支持的协议；定时任务依赖应用进程存活。Alpha 通过 Releases 手动下载升级。
