...
markdown.renderer.rules.link_open=(tokens,index,options,env)=>{
 ...
 const file=projectLink(target,env.project,env.documentPath);
...
export function renderCopilotMarkdown(text,project,documentPath){return markdown.render(text??'',{project,documentPath})}
