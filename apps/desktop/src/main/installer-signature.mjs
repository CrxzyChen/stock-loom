...
/** @param {string} installer @param {string} currentExecutable @param {{inspect?:Function,signal?:AbortSignal}} options */
export async function verifyInstallerPublisher(installer,currentExecutable,{inspect=inspectSignature,signal}={}){
