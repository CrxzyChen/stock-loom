...
export async function browserToolOptions({directory,project,command,entry}){
 ...
 // Each MCP client owns its browser context; a project-wide persistent profile locks out other threads.
 const config={enabled:true,command,args:[entry,'--browser','msedge','--isolated','--output-dir',resolved],env_vars:['ELECTRON_RUN_AS_NODE'],startup_timeout_sec:30,tool_timeout_sec:120,required:false};
