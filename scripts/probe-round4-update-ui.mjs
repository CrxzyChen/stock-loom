...
const record={passed:false,action,actualInstalledApplication:true,from:'0.2.0-beta.2',to:'0.2.0-beta.3',events:[]};
try{
...
finally{await browser.close();await fs.writeFile(`validation/round4-update-ui-${action}.json`,JSON.stringify(record,null,2));console.log(JSON.stringify(record))}
